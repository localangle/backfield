...
_DENY_AUTOLINK_TYPE_PAIRS: frozenset[frozenset[str]] = frozenset(
    {
        ...
        # Linear features are not their containing county or state (e.g. I-294, Cook County, IL).
        frozenset({"street_road", "county"}),
        frozenset({"intersection_road", "county"}),
        frozenset({"intersection_highway", "county"}),
        frozenset({"span", "county"}),
        frozenset({"street_road", "state"}),
        frozenset({"intersection_road", "state"}),
        frozenset({"intersection_highway", "state"}),
        frozenset({"span", "state"}),
