...
- **`text`**: string — verbatim **sentence or paragraph** from the story for that mention (include enough surrounding words that the mention reads naturally in context; do not combine unrelated sentences).
