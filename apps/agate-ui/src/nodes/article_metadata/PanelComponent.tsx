...
const nodeMetadata = {
  ...
  "defaultParams": {
    ...
    "preset_prompts": {
      ...
      "jobs_to_be_done": "### TASK: Classify the **Jobs to be done** of a local news article\n\nChoose the **single dominant job** this story helps readers accomplish.\n\n## Categories\n- Stay informed\n- Make a decision\n- Be entertained\n- Learn how-to\n- Compare options\n- Other\n\n## Article text\n\n{text}\n",
      ...
      "topic": "### TASK: Classify the **Topic** of a local news article\n\nChoose the **single dominant topic** that best describes what the story is about.\n\n## Categories\n- Local news\n- Politics\n- Business\n- Sports\n- Culture\n- Other\n\n## Article text\n\n{text}\n",
