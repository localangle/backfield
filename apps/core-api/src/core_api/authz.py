"""Authorization helpers (session + org/project scope)."""
...
from backfield_auth import verify_service_token
...
def _try_resolve_bearer_api_key(session: Session, raw: str) -> dict[str, Any] | None:
    ...
    *,
    ...
    if authorization:
        try:
            ...
            api_auth = _try_resolve_bearer_api_key(session, token)
