...
@router.get("/stylebooks/{stylebook_slug}/canonical-locations/{canonical_id}/meta")
def get_stylebook_location_meta(
    stylebook_slug: str,
    canonical_id: UUID,
    session: Session = Depends(get_session),
    auth: dict[str, Any] = Depends(get_auth),
...
def update_stylebook_location_meta(
    stylebook_slug: str,
    canonical_id: UUID,
    meta_id: int,
    request: UpdateMetaRequest,
...
def delete_stylebook_location_meta(
    stylebook_slug: str,
    canonical_id: UUID,
    meta_id: int,
    session: Session = Depends(get_session),
