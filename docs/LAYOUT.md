...
| `worker`        | Agate        | Celery consumer; executes graphs via `agate-runtime` |
...
| ------------------ | ----------------------------------------------------------------------------------------------- |
| `agate-runtime`  | `GraphSpec`, synchronous executor, starter flow helpers, node definitions, and vendored Agate runtime |
