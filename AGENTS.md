...
- `packages/backfield-entities`: Entity domain helpers (catalog resolution, canonical matching, substrate↔Stylebook linking, semantic indexing) shared by worker, stylebook-api, core-api, and agate-runtime.
