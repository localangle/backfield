...
Structured data generated by Backfield has been used in real newsrooms for a variety of production applications, experiments and prototypes. Here are several examples:

- Creating **geographically targeted news feeds** that surface articles XX
- **Enriching analytics** with taxonomies XXX
- ARCHIVES
...
- Mapping a newsorom's coverage geographically, auditing sources, and otherwise providing a high-level view of how organizations cover communities.
- BLAH
...
- **Your LLMs of choice**: Backfield supports any model in the [LiteLLM ecosystem]([https://models.litellm.ai/](https://models.litellm.ai/)).
...
- **[Geocodio]([https://www.geocod.io/](https://www.geocod.io/))**: Another permissive geocoder that is used as a fallback and for some special geocoding cases. Also comes with a free tier. For both geocoders, [Nominatim]([https://nominatim.org/](https://nominatim.org/)) is used as a fallback.
