...
<p align="center">
  <i>An open platform for turning journalism into data you can build with</i>
</p>
...
- Annotating articles with **complex taxonomies**, such as user needs and story formats, for the purpose of enriching analytics.
...
Agate is a tool for creating composable data extraction and enrichment workflows. It takes articles and transforms them into structured data that can either be output as JSON or persisted into the Backfield application ecosystem. Users construct workflows from a series of nodes that are designed to extract or enrich specific pieces of information. These nodes can be customized, and new ones can be created by developers.
